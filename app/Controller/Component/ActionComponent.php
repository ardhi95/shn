...
class ActionComponent extends Component 
{
	...
	*/
	...
	)
	{
		...
		$emailLogID				=	$this->saveEMailLog($emailID,$to,$html,$subject,$settings['customer_email'],$settings['company_brand_name']." - <".$settings['customer_email'].">",$model,$model_id);
		
		/*$transport = Swift_SmtpTransport::newInstance('nations.dewa.com',465,"ssl")
		  ->setUsername('customerservice@rebeltac.com')
		  ->setPassword('r3b3lt4c2015');
		...
		/*$message 				=	Swift_Message::newInstance($subject)
		  ->setFrom(array($settings['customer_email'] => $settings['company_brand_name']." - <".$settings['customer_email'].">"))
		  ->setTo(array($to => $to))
