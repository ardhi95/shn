	...
	function ValidateData()
	{
		...
		$this->validate 	= array(
			'name' => array(
				'notBlank' => array(
					'rule' => "notBlank",
					'message' => __d('validation',"Please insert full name")
				),
				'minLength' => array(
					'rule' => array("minLength",3),
					'message' => __d('validation',"Name is too short")
				),
				'maxLength' => array(
					'rule' => array("maxLength",255),
					'message' => __d('validation',"Name is too long")
				)
			),
			'age' => array(
				'notBlank' => array(
					'rule' => "notBlank",
					'message' => __d('validation',"Please insert age")
				),
				'numeric' => array(
			        'rule' => 'numeric',
			...
			'marital_status' =>	array(
				'notBlank'	=>	array(
					'rule'	=>	"notBlank",
					'message' => __d('validation',"Please select marital status")
				)
			),
			'health_record' =>	array(
				'notBlank'	=>	array(
					'rule'	=>	"notBlank",
					'message' => __d('validation',"Please select health record")
				)
			),
			'house' =>	array(
				'notBlank'	=>	array(
			...
			'work_unit_id' =>	array(
				'notBlank'	=>	array(
					'rule'	=>	"notBlank",
					'message' => __d('validation',"Please select work unit")
				)
			),
			'work_shift_id' =>	array(
				'notBlank'	=>	array(
					'rule'	=>	"notBlank",
					'message' => __d('validation',"Please select work shift")
				)
			)
		);
	}
