...
<ul class="breadcrumb push-down-0">
    <li><a href="<?php echo $settings['cms_url'].$ControllerName?>">CMS Menu</a></li>
            ...
            <div class="panel-fullscreen-wrap">
                <div class="panel panel-default panel-fullscreened">
                    <div class="panel-heading">
                        <h3 class="panel-title">Select Icon</h3>
                        ...
                        <div class="input-group col-md-2 pull-right" style="margin-right:20px;">
                            ...
                            <input class="form-control searchIcon" placeholder="Search..." type="text">
                         </div>
                    </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                	<div class="col-md-12">
                        ...
                        <?php echo $this->Form->input("aco_id",
                            array(
                                "div"			=>	array("class"=>"form-group"),
