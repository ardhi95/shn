...
//             },
//     <?php endforeach ?>
//      ,'#ed00e5','#ed0003','#fceb00','#45f400','#3c423f','#6d39c6','#ce6d54'
    
    /* Donut dashboard chart */
    Morris.Donut({
        element: 'dashboard-donut',
        data: [
            <?php foreach ($dataMarital as $dcKey): ?>
                {
                    label:"<?php echo $dcKey[0]['marital_status']; ?>",
                    value:"<?php echo $dcKey[0]['total']; ?>"
                },
            <?php endforeach ?>
        ],
    ...
    <div class="row">
        ...
        <!-- <div class="col-md-3">
        	<div class="widget widget-primary">
                ...
                <div class="widget-int">Rp <span data-toggle="counter" data-to="1564"><?php echo $convTotal; ?></span></div>
                <div class="widget-controls">                                
                    <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget">
                        <span class="fa fa-times"></span>
                    </a>
        ...
        <div class="col-md-3">
            <div class="widget widget-info widget-padding-sm">                            
                <div class="widget-item-left">
                	<input class="knob" data-width="100" data-height="100" data-min="0" data-max="100" data-displayInput=false data-bgColor="#d6f4ff" data-fgColor="#FFF" value="<?= (empty($dataHealtly) ? "0" : $dataHealtly) ?>%" data-readOnly="true" data-thickness=".2"/>
                </div>
                <div class="widget-data">
                    <div class="widget-big-int">
                    	<span class="num-count"><?= (empty($dataHealtly) ? "0" : $dataHealtly) ?></span>%
                    </div>
