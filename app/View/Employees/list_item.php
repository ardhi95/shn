            ...
            <table class="table table-bordered table-striped table-actions">
                <thead>
                    <tr>
                        ...
                        <?php endif;?>
                        <th>No</th>
                        <th><?php echo $this->Paginator->sort("$ModelName.name",__('Name'),array("class"=>"sorting"));?></th>
                        <th><?php echo $this->Paginator->sort("$ModelName.age",__('Age'),array("class"=>"sorting"));?></th>
                        <th>Gender</th>
                        <th>Marital Status</th>
                        <th>Health Record</th>
                        <th><?php echo $this->Paginator->sort("$ModelName.house",__('House'),array("class"=>"sorting"));?></th>
                        <th>Work Unit</th>
                        <th>Work Shift</th>
                        ...
                        <th style="width:12%">
                        	<?php echo $this->Paginator->sort("$ModelName.age",__('Age'),array("class"=>"sorting"));?>
                        </th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
							<?php echo $data[$ModelName]['name']?>
                        </td>
                        <td><?= $data[$ModelName]['age'] ?></td>
                        <td><?= ($data[$ModelName]['gender'] == "m" ? "Male": "Female");?></td>
                        <td><?= ($data[$ModelName]['marital_status'] == "m" ? "Married" : "Single");?></td>
                        <td><?= ($data[$ModelName]['health_record'] == "b" ? "Not" : "Good")?></td>
                        <td><?= $data[$ModelName]['house'] ?> Km</td>
                        <td><?= $data['WorkUnit']['name'] ?></td>
                        <td><?= $data['WorkShift']['name'] ?></td>
                        <!-- <td class="text-center">
							<?php echo $this->General->StatusContent($data[$ModelName]['status'],array("hide"=>__("Not Active"),"show"=>__("Active"))) ?>
                        </td> -->
                        <td class="text-center">
                        	<?php
