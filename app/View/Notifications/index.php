...
function ClearSearchAdvance()
{
	...
	$("#SearchFeatureTypeId > option").removeAttr('selected');
	$("#SearchFeatureDataTypeId > option").removeAttr('selected');
...
<ul class="breadcrumb push-down-0">
    ...
    <li class="active"><?php echo __('List Message')?></li>
</ul>
<!-- END BREADCRUMB -->
    ...
    <div class="content-frame-top">
        ...
        <div class="pull-right">
            ...
            <a href="<?php echo $settings['cms_url'].$ControllerName?>/Add" class="btn btn-primary">
                <i class="fa fa-plus"></i> <?php echo __('Add New Message')?>
            </a>
        </div>
    </div>
</div>
            ...
            <div class="panel panel-success panel-toggled">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php echo $this->Form->input("Search.title",
                            array(
                        ...
                        <?php echo $this->Form->input("Search.message",
                            array(
                                "div"			=>	array("class"=>"form-group"),
                                "label"			=>	array("class"	=>	"col-md-3 control-label","text"=>__("Message")),
                                "between"		=>	'<div class="col-md-6">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <span class="fa fa-search"></span>
                    ...
                    <div class="col-md-6">
						<div class="form-group">
                            <label class="col-md-3 control-label"><?php echo __('Delivery Date')?></label>
                            <div class="col-md-6">
                                <div class="input-group">
