...
$(document).ready(function(){
	...
	//======= TAGET DATE =========/
	$("#SearchOrderStartDate").datepicker({
		format: 'dd MM yyyy',
		autoclose:'true'
	}).on('changeDate', function(ev){
		$("#SearchOrderEndDate").removeAttr("disabled");
		$('#SearchOrderEndDate').val('');
		$("#SearchOrderEndDate").datepicker('setStartDate',$(this).val());
		$(this).datepicker('hide');
	});
	
	$("#SearchOrderEndDate").datepicker({
		format: 'dd MM yyyy',
		autoclose:'true'
	}).on('changeDate', function(ev){
		$(this).datepicker('hide');
            ...
            <div class="panel panel-success panel-toggled">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php echo $this->Form->input("Search.order_id",
                            array(
                                "div"			=>	array("class"=>"form-group"),
                                "label"			=>	array("class"	=>	"col-md-3 control-label","text"=>__("Order ID")),
                    ...
                    <div class="col-md-6">
                    	...
                    	<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker" id="SearchOrderStartDate" name="data[Search][start_date]"/>
                                    <span class="input-group-addon add-on"> - </span>
                                    <input type="text" class="form-control datepicker" id="SearchOrderEndDate" name="data[Search][end_date]" disabled="disabled"/>
                                </div>
                            </div>
                        </div>
