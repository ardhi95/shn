                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php if($data[$ModelName]['status']=="1"):?>
                            	<a href="javascript:void(0);" class="btn btn-success btn-condensed btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo __('Deactivate')?>" onclick="ChangeStatus(this,'<?php echo __('Do you realy want deactivate this sales ?')?>','<?php echo $data[$ModelName]['id']?>','0')" <?php echo $disabledStatus?>><i class="fa fa-chevron-down"></i></a>
                            <?php else:?>
                            	<a href="javascript:void(0);" class="btn btn-success btn-condensed btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo __('Activate')?>" onclick="ChangeStatus(this,'<?php echo __('Do you realy want activate this sales ?')?>','<?php echo $data[$ModelName]['id']?>','1')" <?php echo $disabledStatus?>><i class="fa fa-chevron-up"></i></a>
                            <?php endif;?>
