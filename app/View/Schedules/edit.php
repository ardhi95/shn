    ...
    <div class="row">
    	<div class="col-md-12">
            ...
            <?php
				$disabled	=	"";
				$disabled2	=	"";
				if($detail[$ModelName]["checkin_status_id"] == "2")
				{
					$disabled	=	"disabled";
		   ...
		   ?>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-footer">
                    ...
                    <button type="submit" onclick="OnClickSaveDirect()" class="btn btn-primary pull-right" style="margin-left:10px;" <?php echo $disabled2?>><?php echo __('Save')?><span class="fa fa-floppy-o fa-right"></span></button>
