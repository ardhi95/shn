            ...
            <table class="table table-bordered table-striped table-actions">
                <thead>
                    <tr>
                        ...
                        <th style="width:12%">
                        	<?php echo $this->Paginator->sort("Sales.fullname",__('Sales'),array("class"=>"sorting"));?>
                        </th>
                        
                        <th style="width:12%">
                        	<?php echo $this->Paginator->sort("$ModelName.schedule_date",__('Date'),array("class"=>"sorting"));?>
                        </th>
                        
                        <th style="width:12%">
                        	<?php echo $this->Paginator->sort("Store.name",__('Store'),array("class"=>"sorting"));?>
                        </th>
                        
                        <th style="width:11%" class="text-center">
                        	<?php echo $this->Paginator->sort("CheckinStatus.name",__('Checkin Status'),array("class"=>"sorting"));?>
                        </th>
                ...
                <tbody>
                    ...
                    <tr>
						...
						if($data[$ModelName]["checkin_status_id"] == "2")
						{
                    	...
                    	<td class="text-center">
                        	<input type="checkbox" id="chck_<?php echo $data[$ModelName]['id']?>" value="<?php echo $data[$ModelName]['id']?>" class="icheckbox" <?php echo $disabledCheck?>/>
                        </td>
                        <?php endif;?>
                    	<td><?php echo $no ?></td>
                        <td>
							<?php echo $data["Sales"]['fullname']?>
                        </td>
                        <td>
                        	<?php echo date("D, d M Y H:i",strtotime($data[$ModelName]['schedule_date']))?>
                        </td>
                        
                        <td>
							<?php echo $this->General->IsEmptyVal($data["Store"]['name'])?>
                        </td>
                        <td>
                            <?php echo $this->General->CheckinStatus($data["CheckinStatus"]['id'],$data["CheckinStatus"]['name']) ?>
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?php echo $settings['cms_url'].$ControllerName?>/Detail/<?php echo $data[$ModelName]["id"]?>/<?php echo $page?>/<?php echo $viewpage?>" class="btn btn-primary btn-condensed btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo __('View')?>" <?php echo $disabledView?>><i class="fa fa-eye"></i></a>
