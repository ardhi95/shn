            ...
            <table class="table table-bordered table-striped table-actions">
                <thead>
                    <tr>
                        ...
                        <th style="width:12%">
                        	<?php echo $this->Paginator->sort("$ModelName.address",__('Address'),array("class"=>"sorting"));?>
                        </th>
                        <th style="width:11%">
                        	<?php echo $this->Paginator->sort("$ModelName.phone1",__('Phone'),array("class"=>"sorting"));?>
                        </th>
                        
                         <th style="width:12%" class="text-center">
                         	<?php echo $this->Paginator->sort("$ModelName.hasorder",__('Has Order Yet'),array("class"=>"sorting"));?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
							<?php echo $this->General->IsEmptyVal($this->Text->truncate($data[$ModelName]['address'],30,array("ending"=>"..")))?>
                        </td>
                        <td>
							<?php echo $this->General->IsEmptyVal($data[$ModelName]['phone1'])?>
                        </td>
                        <td class="text-center">
                        	<?php if(!empty($data["Order"]["id"])):?>
                        		<span class="label label-success label-form">Yes</span>
                            <?php else:?>
                            	<span class="label label-danger label-form">No</span>
                            <?php endif;?>
                        </td>
                        <td class="text-center">
